...
type IndexerMeta struct {
	...
	ListSelector      string // Selector for the list of items (default: .capa_lista)
	ContainerSelector string // Selector for the article/content container (default: .conteudo)
}
